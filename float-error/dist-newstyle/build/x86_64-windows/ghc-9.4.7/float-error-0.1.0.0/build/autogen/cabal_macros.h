...
/* package float-error-0.1.0.0 */
#ifndef VERSION_float_error
#define VERSION_float_error "0.1.0.0"
#endif /* VERSION_float_error */
#ifndef MIN_VERSION_float_error
#define MIN_VERSION_float_error(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_float_error */
...
#define CURRENT_PACKAGE_KEY "float-error-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "float-error-0.1.0.0-inplace"
